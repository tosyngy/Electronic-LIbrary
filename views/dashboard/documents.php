...
<div  id="main-content" style="margin-top: 50px;text-align: center"> 
    ...
    <div class="feeds">
        ...
        if (!empty($detail))
            foreach ($detail as $key => $value) {
                ...
                <div class="feeds-content">
                    <div class="feeds-title"><?php echo $value["title"]; ?>: <?php echo $value["cat"]; ?></div>   
                ...
                <!--                                        <button type="button" class="kv-file-upload btn btn-xs btn-default" title="Upload file">   <i class="glyphicon glyphicon-upload text-info"></i>
                                            ...
                                            <div class="kv-file-remove btn btn-xs btn-default hidden" title="Delete file"><a href="<?php echo "http://localhost/ElibraryGA/dashboard/delete/file"; ?>"  file_id="<?php echo $value1["id"]; ?>" class="delete"  ><i class="glyphicon glyphicon-trash text-danger"></a></i></div>
                                        </div>
        ...
        <!--                                        <button type="button" class="kv-file-upload btn btn-xs btn-default" title="Upload file">   <i class="glyphicon glyphicon-upload text-info"></i>
                                ...
                                <div class="kv-file-remove btn btn-xs btn-default hidden" title="Delete Document"><a  file_id="<?php echo $value["id"]; ?>" class="delete" href="<?php echo "http://localhost/ElibraryGA/dashboard/delete/document"; ?>"><i class="glyphicon glyphicon-trash text-danger"></i></a></div>
                            </div>
