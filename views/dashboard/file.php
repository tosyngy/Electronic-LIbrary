...
<head>
    ...
    <link href="<?php echo URL ?>views/dashboard/file_upload/themes/explorer-fa/theme.css" media="all" rel="stylesheet" type="text/css"/>
    <script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
    <script src="<?php echo URL ?>views/dashboard/file_upload/js/plugins/sortable.js" type="text/javascript"></script>
    <script src="<?php echo URL ?>views/dashboard/file_upload/js/fileinput.js" type="text/javascript"></script>
    <script src="<?php echo URL ?>views/dashboard/file_upload/js/locales/fr.js" type="text/javascript"></script>
    <script src="<?php echo URL ?>views/dashboard/file_upload/js/locales/es.js" type="text/javascript"></script>
    <script src="<?php echo URL ?>views/dashboard/file_upload/themes/explorer-fa/theme.js" type="text/javascript"></script>
    <script src="<?php echo URL ?>views/dashboard/file_upload/themes/fa/theme.js" type="text/javascript"></script>
