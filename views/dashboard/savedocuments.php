...
<section id="main-content" style="">
    ...
    <!--                    <span class="fa fa-attachment label"> attachment : </span>-->
                    ...
                    <div class="file-actions" style=" background-color: rgba(255,255,255,0.7);margin-left: 10px; padding: 20px;">
                        ...
                        <div class="file-edit-indicator" title="Edit Information"><a href="http://localhost/ElibraryGA/dashboard/editsave/<?php echo $value["id"]; ?>/2"><i class="glyphicon glyphicon-pencil text-warning"></i></a></div>
